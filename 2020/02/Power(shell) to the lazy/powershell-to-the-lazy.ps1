...
$presentationRoot = 'C:\Code\Github\PowerShell-Usergroup-Material\2020\02\Power(shell) to the lazy'
...
- ImportExcel (Interacting with Excel format)
#>
...
Invoke-PSMDTemplate MyFunction -OutPath C:\Temp
code C:\Temp\Get-Something.ps1
...
code C:\Code\Github\PSUtil\PSUtil\internal\keybindings\addToHistory.ps1

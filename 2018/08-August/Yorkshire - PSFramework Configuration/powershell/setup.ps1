$setupCode = {
    ...
    $filesRoot = Join-Path $rootPresentationPath "PowerShell-Usergroup-Material\2018\08-August\Yorkshire - PSFramework Configuration\powershell"
    $moduleRoot = Join-Path $rootPresentationPath "PowerShell-Usergroup-Material\2018\08-August\Yorkshire - PSFramework Configuration\modules\BeerFactory\BeerFactory"
